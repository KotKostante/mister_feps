  ...
  return (
    <>
      <Section>
        ...
        <SectionHeading title="Цены на клининг для юридических лиц" text="Показываем ориентиры “от”, а точную стоимость фиксируем после осмотра: площадь, загрязнения, график, расходники, документы и срочность влияют на смету." />
      ...
      <Section className="bg-surface">
        <SectionHeading title="Три формата обслуживания" text="Формат выбирается не по красивому названию тарифа, а по рискам объекта и требованиям к контролю." />
      ...
      <Section>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => <Card key={service.slug}><h2 className="font-semibold">{service.title}</h2><p className="mt-2 text-primary">{service.priceFrom}</p></Card>)}
        </div>
      </Section>
      <FinalCta />
    </>
